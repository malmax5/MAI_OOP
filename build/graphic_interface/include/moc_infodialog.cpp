/****************************************************************************
** Meta object code from reading C++ file 'infodialog.hpp'
**
...
#include "../../../graphic_interface/include/infodialog.hpp"
...
#error "The header file 'infodialog.hpp' doesn't include <QObject>."
...
constexpr auto qt_meta_stringdata_CLASSColorWidgetENDCLASS = QtMocHelpers::stringData(
    "ColorWidget"
);
...
constexpr auto qt_meta_stringdata_CLASSInfoDialogENDCLASS = QtMocHelpers::stringData(
    "InfoDialog"
);
#else  // !QT_MOC_HAS_STRINGDATA
#error "qtmochelpers.h not found or too old."
